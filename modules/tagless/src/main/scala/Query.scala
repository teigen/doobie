...
// import fs2.Stream
// import doobie.{ Read, Write, Fragment }
...
//     * @group Results
//     */
//   // def to[C[_]](a: A)(implicit cbf: CanBuildFrom[Nothing, B, C[B]]): ConnectionIO[C[B]] =
//   //   new Unapplied[Connection, C[B]] {
//   //     def on[F[_]: Sync](c: Connection[F]): F[C[B]] =
//   //       c.to[C, B](toFragment(a))
//   //   }
